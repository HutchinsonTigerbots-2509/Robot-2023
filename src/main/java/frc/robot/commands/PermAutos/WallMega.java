...
public class WallMega extends InstantCommand {
  ...
  public WallMega(
    ...
    Commands.parallel(
      ...
      new DriveAutoGyro(drivetrain, -.6, 0).withTimeout(0.6).andThen(
      new DriveAutoGyro(drivetrain, -.5, 0).withTimeout(0.4).andThen(
      new DriveAutoGyro(drivetrain, -.4, 0).withTimeout(0.4).andThen(
      new DriveAutoGyro(drivetrain, -.3, 0).withTimeout(0.5).andThen(
    ...
    Commands.parallel(
      ...
      new DriveAutoGyro(drivetrain, .4, 0).withTimeout(.65))),
    ...
    Commands.parallel(
      new DriveAutoGyro(drivetrain, -.8, 0).withTimeout(1.6),
      new TuckPosition(pDislocator, pElbow, pShoulder, pTravelator)),
    Commands.parallel(
