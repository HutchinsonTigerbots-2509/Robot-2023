...
public class Station1DropLowGrab extends InstantCommand {
  ...
  public Station1DropLowGrab(
    ...
    Commands.sequence(
      ...
      Commands.parallel(
        new DriveAuto(drivetrain, -.4).withTimeout(1.8),
      ...
      Commands.parallel(
        new DriveAuto(drivetrain, .4).withTimeout(2.5),
