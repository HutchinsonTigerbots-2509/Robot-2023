...
public class TestAuto extends InstantCommand {
  ...
  public TestAuto(
    ...
    blueCommandSequence = Commands.sequence(new DriveAutoGyro(pDrivetrain, 0, 0, 180));

    redCommandSequence = Commands.sequence(new DriveAutoGyro(pDrivetrain, 0, 0, 180));
