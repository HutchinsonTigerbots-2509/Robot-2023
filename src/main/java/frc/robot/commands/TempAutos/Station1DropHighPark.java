...
public class Station1DropHighPark extends InstantCommand {
  ...
  public Station1DropHighPark(
    ...
    Commands.sequence(
      ...
      new DriveAutoGyro(pDrivetrain, 0, 0, 180).withTimeout(2),
      new DriveAuto(pDrivetrain, 0.3).withTimeout(.5),
      new GrabOpen(wrist).withTimeout(.2),
      new DriveAutoGyro(pDrivetrain, .3, .5, 180),
      new DriveAuto(pDrivetrain, 0.3).withTimeout(1),
