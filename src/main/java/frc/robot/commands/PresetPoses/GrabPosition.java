...
public class GrabPosition extends InstantCommand {
...
private Wrist wrist;
  ...
  public GrabPosition(Dislocator pDislocator, Elbow pElbow, Shoulder pShoulder, Wrist pWrist) {
  ...
  public void initialize() {
    new DislocatorMoveToPosition(-15, dislocator);
    new ShoulderMoveToPosition(-490, shoulder);
    new ElbowMoveToPosition(-25, elbow);
    new WristMoveToPosition(90, wrist);
  }
}