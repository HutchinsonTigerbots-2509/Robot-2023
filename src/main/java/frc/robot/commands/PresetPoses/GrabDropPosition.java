...
public class GrabDropPosition extends SequentialCommandGroup {
  ...
  public GrabDropPosition(
    ...
    addCommands(
        Commands.parallel(
            ...
            new ShoulderMoveToPosition(-92, shoulder),
            new WaitCommand(0.25).andThen(new ElbowMoveToPosition(31, elbow)).withTimeout(1.5),
